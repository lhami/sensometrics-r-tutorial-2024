...
3.  **Download the tutorial materials** by [going to the `code/pangborn-2023-code-download.zip` file](https://github.com/lhami/pangborn-r-tutorial-2023/blob/main/code/pangborn-2023-code-download.zip) in this repo and clicking `Download`.
