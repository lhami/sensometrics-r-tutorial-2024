...
```{r combining plots with patchwork, fig.width=7}
library(patchwork)
...
```{r arranging plots vertically with patchwork, fig.height=7}
plot(berry_mfa_res, choix = "var") / plot(berry_mfa_res, partial = "all")
```
...
```{r collecting legends at the bottom of a patchwork ensemble, fig.width = 7}
plot(berry_mfa_res, choix = "var") + plot(berry_mfa_res, partial = "all") +
...
```{r more complex patchwork layout, fig.width = 7}
