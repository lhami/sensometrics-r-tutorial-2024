...
author: 
  ...
  - Leah Hamilton^[Virginia State University, lmhamilton@ucdavis.edu]
...
3.  Principles of tidy data analysis using `tidyverse`
  ...
  2. Subsetting data
  3. Workflows
  4. Combining and altering data
  5. Split-apply-combine
  6. Wider and longer data
  7. Other data-wrangling utilities
4.  Data analysis outside the `tidyverse`
  1. Correspondence Analysis overview
  2. Working with binary, count, and character data
  3. Untidying & Retidying data
5.  Basics of data visualization in `R`/`ggplot2`
