...
1.  Under `General`, uncheck all the boxes to do with restoring projects and workspaces.  We want to make sure our code runs cleanly, and letting RStudio load these will make this impossible:
